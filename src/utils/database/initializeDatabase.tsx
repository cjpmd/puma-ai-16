...
async function createCriticalTables() {
  ...
  try {
    ...
    console.log('Profiles table may already exist:', err?.message);
  }
  ...
  try {
    ...
    console.log('Teams table may already exist:', err?.message);
  }
  ...
  try {
    ...
    console.log('Players table may already exist:', err?.message);
  }
  ...
  try {
    ...
    console.log('Game formats table may already exist:', err?.message);
  }
  ...
  try {
    ...
    console.log('Performance categories table may already exist:', err?.message);
  }
  ...
  try {
    ...
    console.log('Team settings table may already exist:', err?.message);
  }
}
